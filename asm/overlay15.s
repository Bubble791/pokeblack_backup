	...
	.include "overlay15.inc"
	.include "global.inc"

	.text

	thumb_func_start ovy15_216e660
ovy15_216e660: ; 0x0216E660
...
_0216E6DE:
	...
	blx MI_CpuFill8
	ldr r0, [r5]
	ldr r1, _0216E768 ; =0x000000BB
	str r0, [r5, #0xc]
	ldr r0, [r5, #4]
	ldr r2, _0216E76C ; =0x021EA06C
	str r0, [r5, #0x10]
	ldrb r0, [r5, #0x18]
	strb r0, [r5, #0x14]
	ldrb r0, [r5, #0x19]
...
_0216E768: .word 0x000000BB
_0216E76C: .word 0x021EA06C
	thumb_func_end ovy15_216e660

	thumb_func_start ovy15_216e770
ovy15_216e770: ; 0x0216E770
	push {r3, r4, r5, r6, r7, lr}
	ldr r2, _0216E7A4 ; =ovy15_216e660
	ldr r6, [r1]
	add r5, r0, #0
	mov r1, #0
	mov r3, #0x1c
	...
	pop {r3, r4, r5, r6, r7, pc}
	nop
_0216E7A4: .word ovy15_216e660
	thumb_func_end ovy15_216e770
_0216E7A8:
