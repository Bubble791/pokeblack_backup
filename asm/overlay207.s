...
sub_021B5394: ; 0x021B5394
	ldr r3, _021B539C ; =sub_0203A24C
	add r0, r1, #0
	bx r3
	nop
_021B539C: .word sub_0203A24C
...
sub_021B8594: ; 0x021B8594
	ldr r3, _021B859C ; =sub_0203A24C
	add r0, r1, #0
	bx r3
	nop
_021B859C: .word sub_0203A24C
...
sub_021BA8E8: ; 0x021BA8E8
	...
	add r1, r3, r1
	lsl r1, r1, #0x10
	ldr r3, _021BA8FC ; =sub_0204C488
	lsr r1, r1, #0x10
	bx r3
	.align 2, 0
_021BA8FC: .word sub_0204C488
