...
_021BB488:
	ldrh r0, [r4, #2]
	ldr r3, [sp, #0x10]
	ldr r1, _021BB548 ; =0x020946BC
	asr r0, r0, #4
	lsl r2, r0, #2
	ldr r0, _021BB548 ; =0x020946BC
	mov ip, r3
	add r0, r0, r2
	ldrsh r2, [r1, r2]
	mov r1, #2
...
_021BC7F4:
	...
	lsl r1, r0, #1
	lsl r2, r1, #1
	ldr r0, _021BC964 ; =0x020946BC
	add r1, r1, #1
	ldrsh r0, [r0, r2]
	lsl r2, r1, #1
	ldr r1, _021BC964 ; =0x020946BC
	neg r0, r0
	ldrsh r1, [r1, r2]
	bl sub_02074BF4
	ldr r1, [r7]
...
_021BDC06:
	...
	bl sub_021BBCB4
	ldr r0, [r6, #0x1c]
	ldr r1, _021BDDEC ; =0x020946BC
	str r0, [sp, #0xc]
	ldr r0, [sp, #8]
	asr r0, r0, #4
	lsl r2, r0, #2
	ldr r0, _021BDDEC ; =0x020946BC
	ldrsh r1, [r1, r2]
	add r3, r0, r2
	mov r2, #2
	ldrsh r2, [r3, r2]
