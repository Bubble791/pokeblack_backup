...
sub_021EF288: ; 0x021EF288
	ldr r0, [r0]
	ldr r3, _021EF290 ; =ovy36_21b83b4
	bx r3
	nop
_021EF290: .word ovy36_21b83b4
...
_021EF93E:
	...
	asr r0, r1, #4
	lsl r2, r0, #2
	ldr r0, _021EFA00 ; =FX_SinCosTable_ ; 0x020946BC
	ldrsh r0, [r0, r2]
	lsl r2, r0, #3
	cmp r1, #0
	bne _021EF9B2
...
_021EF9A2:
	...
	mov r0, #0x20
	lsl r2, r1, #2
	ldr r1, _021EFA00 ; =FX_SinCosTable_ ; 0x020946BC
	ldrsh r0, [r4, r0]
	ldrsh r1, [r1, r2]
	add r2, r0, #0
	mul r2, r1
...
_021EFA00: .word FX_SinCosTable_
...
_021EFC2C:
	asr r0, r0, #4
	lsl r1, r0, #2
	ldr r0, _021EFCB0 ; =FX_SinCosTable_ ; 0x020946BC
	ldrsh r0, [r0, r1]
	cmp r0, #0
	bne _021EFC4A
	mov r1, #0xc
...
_021EFCA4:
	...
	pop {r3, r4, r5, r6, r7, pc}
	.align 2, 0
_021EFCB0: .word FX_SinCosTable_
