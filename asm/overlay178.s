...
sub_0219B8B8: ; 0x0219B8B8
	ldr r3, _0219B8C0 ; =MI_CpuFill8
	mov r1, #0
	mov r2, #0x1c
	bx r3
	.align 2, 0
_0219B8C0: .word MI_CpuFill8
...
sub_0219BD98: ; 0x0219BD98
	ldr r3, _0219BDA0 ; =MI_CpuFill8
	mov r1, #0
	mov r2, #0x84
	bx r3
	.align 2, 0
_0219BDA0: .word MI_CpuFill8
...
ovy178_219c19c: ; 0x0219C19C
	...
	ldrh r4, [r3, #8]
	lsl r3, r2, #1
	ldr r2, _0219C244 ; =FX_SinCosTable_ ; 0x020946BC
	mov r5, #0x1f
	ldrsh r3, [r2, r3]
	mov r2, #1
	lsl r2, r2, #0xc
	...
	pop {r3, r4, r5, r6, r7, pc}
	nop
_0219C244: .word FX_SinCosTable_
...
sub_0219C29C: ; 0x0219C29C
	...
	ldr r3, _0219C2A8 ; =MI_CpuFill8
	mov r1, #0
	bx r3
	.align 2, 0
_0219C2A4: .word 0x00000534
_0219C2A8: .word MI_CpuFill8
...
_0219C372:
	...
	lsl r0, r0, #1
	lsl r1, r0, #1
	ldr r2, _0219C3F8 ; =FX_SinCosTable_ ; 0x020946BC
	add r0, r0, #1
	lsl r0, r0, #1
	ldrsh r0, [r2, r0]
	ldrsh r1, [r2, r1]
...
_0219C3F8: .word FX_SinCosTable_
...
_0219C420:
	...
	lsr r0, r0, #0x10
	asr r0, r0, #4
	ldr r2, _0219C4C4 ; =FX_SinCosTable_ ; 0x020946BC
	lsl r0, r0, #2
	add r1, r2, r0
	ldrsh r0, [r2, r0]
	mov r2, #2
...
_0219C4C4: .word FX_SinCosTable_
...
sub_0219C664: ; 0x0219C664
	ldr r3, _0219C66C ; =MI_CpuFill8
	mov r1, #0
	mov r2, #0x10
	bx r3
	.align 2, 0
_0219C66C: .word MI_CpuFill8
