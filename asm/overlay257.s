...
sub_0219C10C: ; 0x0219C10C
	...
	add r2, #0x1c
	add r0, r2, #0
	ldr r3, _0219C128 ; =sub_020787A8
	mov r2, #0x22
	bx r3
	.align 2, 0
_0219C128: .word sub_020787A8
...
sub_0219F26C: ; 0x0219F26C
	ldr r3, _0219F274 ; =sub_0203A24C
	add r0, r1, #0
	bx r3
	nop
_0219F274: .word sub_0203A24C
...
sub_021A0AE0: ; 0x021A0AE0
	ldr r3, _021A0AE8 ; =sub_0203A24C
	add r0, r1, #0
	bx r3
	nop
_021A0AE8: .word sub_0203A24C
...
sub_021A22F8: ; 0x021A22F8
	ldr r3, _021A2300 ; =sub_0203A24C
	add r0, r1, #0
	bx r3
	nop
_021A2300: .word sub_0203A24C
...
sub_021A8B74: ; 0x021A8B74
	...
	ldr r3, _021A8B84 ; =sub_02006254
	bx r3
	.align 2, 0
_021A8B80: .word 0x0000054B
_021A8B84: .word sub_02006254
...
sub_021A8E04: ; 0x021A8E04
	mov r2, #2
	ldr r0, [r0, #4]
	ldr r3, _021A8E10 ; =sub_0207866C
	lsl r2, r2, #0xc
	bx r3
	nop
_021A8E10: .word sub_0207866C
...
sub_021A8E48: ; 0x021A8E48
	ldr r3, _021A8E50 ; =sub_020787A8
	mov r1, #0
	mov r2, #0x10
	bx r3
	.align 2, 0
_021A8E50: .word sub_020787A8
