...
sub_021B46AC: ; 0x021B46AC
	...
	ldr r0, [r2, #0x20]
	ldr r2, [r2, #0x2c]
	ldr r3, _021B46B8 ; =GFL_MsgDataLoadStrbuf
	bx r3
	nop
_021B46B8: .word GFL_MsgDataLoadStrbuf
...
sub_021B5074: ; 0x021B5074
	...
	lsl r1, r2, #0x10
	ldr r0, [r0, #0x74]
	ldr r3, _021B5084 ; =Oam_SetOamAnimIndex
	lsr r1, r1, #0x10
	bx r3
	nop
_021B5084: .word Oam_SetOamAnimIndex
...
sub_021B518C: ; 0x021B518C
	add r0, #0xac
	ldr r0, [r0]
	ldr r3, _021B5198 ; =Oam_SetOamAnimIndex
	mov r1, #2
	bx r3
	nop
_021B5198: .word Oam_SetOamAnimIndex
...
sub_021B52D4: ; 0x021B52D4
	add r0, #0xac
	ldr r0, [r0]
	ldr r3, _021B52E0 ; =Oam_EnableOamAnim
	mov r1, #1
	bx r3
	nop
_021B52E0: .word Oam_EnableOamAnim
