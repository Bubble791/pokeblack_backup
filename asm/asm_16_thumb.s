...
sub_0205F904: ; 0x0205F904
	ldr r3, _0205F908 ; =GXS_LoadOAM
	bx r3
	.align 2, 0
_0205F908: .word GXS_LoadOAM
	thumb_func_end sub_0205F904

	thumb_func_start sub_0205F90C
sub_0205F90C: ; 0x0205F90C
	ldr r3, _0205F910 ; =GXS_LoadOBJ
	bx r3
	.align 2, 0
_0205F910: .word GXS_LoadOBJ
...
sub_02060650: ; 0x02060650
	...
	add r1, r1, r3
	ldr r3, _0206065C ; =MIi_CpuCopy16
	bx r3
	.align 2, 0
_02060658: .word 0x07000400
_0206065C: .word MIi_CpuCopy16
...
sub_02060660: ; 0x02060660
	...
	lsl r3, r3, #0x18
	add r1, r1, r3
	ldr r3, _0206066C ; =MIi_CpuCopy16
	bx r3
	nop
_0206066C: .word MIi_CpuCopy16
...
_0206212C:
	...
	add r0, #0x4c
	ldrh r0, [r0]
	ldr r2, _020621A8 ; =FX_SinCosTable_ ; 0x020946BC
	asr r0, r0, #4
	lsl r1, r0, #1
	lsl r0, r1, #1
	add r1, r1, #1
...
_020621A8: .word FX_SinCosTable_
...
_020621F2:
	...
	beq _02062210
	ldrh r0, [r5, #0x1c]
	ldr r2, _02062234 ; =FX_SinCosTable_ ; 0x020946BC
	asr r0, r0, #4
	lsl r1, r0, #1
	lsl r0, r1, #1
	add r1, r1, #1
...
_02062234: .word FX_SinCosTable_
...
_020626F8:
	...
	add r0, #0x58
	ldrh r0, [r0]
	ldr r2, _02062748 ; =FX_SinCosTable_ ; 0x020946BC
	asr r0, r0, #4
	lsl r1, r0, #1
	lsl r0, r1, #1
	add r1, r1, #1
...
_02062748: .word FX_SinCosTable_
